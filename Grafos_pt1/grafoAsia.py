...
china = pais.Destino("China", "Pekin", "The Ritz-Carlton", 5, 650, ["Visita al Kremlin", "Recorrido por la Plaza Roja"])
japon = pais.Destino("Japon", "Tokio", "Hotel Imperial", 5, 650, ["Visita al Templo Senso-ji", "Recorrido por la Torre de Tokio"])
taiwan = pais.Destino("Taiwan", "Taipei", "Hotel Eslite", 5, 650, ["Visita al Palacio Nacional de Taiwán", "Recorrido por Taipei 101"])
tailandia = pais.Destino("Tailandia", "Bangkok", "	Mandarin Oriental", 5, 650, ["Visita al Gran Palacio", "Recorrido por el Templo del Buda Esmeralda"])
arabiaSaudita = pais.Destino("Arabia Saudita", "Riad", "The Ritz-Carlton", 5, 650, ["Visita al Kingdom Centre Tower", "Recorrido por El Murabba Palace,"])
india = pais.Destino("India", "Nueva Delhi", "The Leela Palace", 5, 650, ["Visita al Taj Mahal", "Recorrido por Fuerte Rojo de Delhi"])
indonesia = pais.Destino("Indonesia", "Yakarta", "Hotel Indonesia", 5, 650, ["Visita al Monumento Nacional de Indonesia", "Recorrido por la Isla de Bali"])
coreaDelSur = pais.Destino("Corea del Sur", "Seul", "The Shilla", 5, 650, ["Visita al Palacio Gyeongbokgung", "Recorrido por la Torre de Seúl"])
filipinas = pais.Destino("Filipinas", "Manila", "Okada Manila", 5, 650, ["Visita a Intramuros", "Recorrido por la Bahía de Manila"])
